...
public abstract class BaseSwipeMenuExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public abstract boolean isGroupSwipeable(int groupPosition);

    public abstract boolean isChildSwipeable(int groupPosition, int childPosition);
    ...
    public abstract ContentViewWrapper getChildViewAndReUsable(int groupPosition, int childPosition, boolean isLastChild, View convertView,
 ViewGroup parent);
