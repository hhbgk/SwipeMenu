...
public class SwipeMenuExpandableListAdapter implements ExpandableListAdapter, OnSwipeItemClickListenerForExpandable {
    ...
    public void notifyDataSetChanged(boolean ifKeepMenuOpen) {
        ...
        if (i >= 0 && tv != null
            ...
            if (mList.getParent() instanceof RelativeLayout) {
                LayoutParams lp = (LayoutParams) mList.getLayoutParams();
                lpNew = new LayoutParams(tv.getWidth(), tv.getHeight());
                ((LayoutParams) lpNew).setMargins(lp.leftMargin, sLo[1] - fLo[1], lp.rightMargin, 0);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        if (!mAdapter.isGroupSwipeable(groupPosition))
        ...
        if (convertView == null || !(convertView instanceof SwipeMenuLayout) || !contentViewWrapper.ifReUsable) {
            ...
            SwipeMenuViewForExpandable menuView = new SwipeMenuViewForExpandable(menu, (SwipeMenuExpandableListView) parent, groupPosition, GROUP_INDEX);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
            ViewGroup parent) {
        if (!mAdapter.isChildSwipeable(groupPosition, childPosition)) {
